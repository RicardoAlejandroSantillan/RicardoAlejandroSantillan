- Hola, soy @RicardoAlejandroSantillan
- Estoy interesado en Desarrollo movil, paginas web, aplicaciones de escritorio y ciencia de datos.
- Actualmente estoy metido en desarrollo de aplicaciones web con modelos vistrolador (mvc) usando sql server. Proximamente complementarll con desarrollo movil.
